...
-- GRANT ALL PRIVILEGES ON DATABASE ehrbase.tenant TO :db_user_admin;
-- GRANT ALL PRIVILEGES ON DATABASE ehrbase.system TO :db_user_admin;
-- GRANT ALL PRIVILEGES ON DATABASE ehrbase.template. TO :db_user_admin;
-- GRANT ALL PRIVILEGES ON DATABASE ehrbase.compostion TO :db_user_admin;
-- GRANT ALL PRIVILEGES ON DATABASE ehrbase.ehr TO :db_user_admin;
...
GRANT ALL PRIVILEGES ON SCHEMA ehr TO :db_user_admin;
GRANT ALL PRIVILEGES ON SCHEMA ext TO :db_user_admin;

ALTER DEFAULT PRIVILEGES IN SCHEMA ehr GRANT ALL PRIVILEGES ON TABLES TO :db_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA ehr GRANT ALL PRIVILEGES ON TABLES TO :db_user_admin;
